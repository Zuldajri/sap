...
cd $INSTALLERHOME/SAP_HANA_CLIENT

# Install HANA client using hdbinst
$INSTALLERHOME/SAP_HANA_CLIENT/hdbinst --sapmnt=$INSTALLERHOME/SAP_HANA_CLIENT

cd $INSTALLERHOME/SAP_HANA_STUDIO

mkdir STUDIO_PATH

# Install HANA Studio on Linux
$INSTALLERHOME/SAP_HANA_STUDIO/hdbinst -a studio -b --path=$INSTALLERHOME/SAP_HANA_STUDIO/STUDIO_PATH
