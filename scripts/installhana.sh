...
# extract LCAPPS
$INSTALLERHOME/SAPCAR_1010-70006178.EXE -manifest SAP_HANA_LCAPPS/SIGNATURE.SMF -xf $INSTALLERHOME/IMDB_LCAPPS_2055_0-20010426.SAR
...
cd $INSTALLERHOME/SAP_HANA_LCAPPS
