...
export DB_SYSTEMDB_PASSWORD=$3
export HA_CLUSTER_PASSWORD=$4
export OS_SAPADM_PASSWORD=$5
export OS_SIDADM_PASSWORD=$6
...
export HANA_IMAGE_OFFER=${14}
export HANA_IMAGE_PUBLISHER=${15}
export HANA_IMAGE_SKU=${16}
export STORAGE_ACCOUNT_NAME=${17}
export STORAGE_ACCESS_KEY=${18}
export PROXIMITY_PLACEMENT_GROUP=${19}
export RESOURCE_GROUP_NAME=${20}
export SUBNET_MANAGEMENT_NAME=${21}
export SUBNET_MANAGEMENT_PREFIX=${22}
export SUBNET_APP_NAME=${23}
export SUBNET_APP_PREFIX=${24}
export SUBNET_DB_NAME=${25}
export SUBNET_DB_PREFIX=${26}
export SAP_USER=${27}
export SAP_PASSWORD=${28}
export SCS_STATIC_IP=${29}
export APP1_STATIC_IP=${30}
export APP2_STATIC_IP=${31}
export APP3_STATIC_IP=${32}
export WEB_STATIC_IP=${33}
export PRIVATE_KEY=${34}
