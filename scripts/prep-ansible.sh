...
export DB_VERSION=$6
export INSTANCE_NUMBER=$7
export SID=$8
export HANA_STATIC_IP=$9
export HANA_ADMIN_STATIC_IP=${10}
export HANA_LB_IP=${11}
export HANA_IMAGE_OFFER=${12}
export HANA_IMAGE_PUBLISHER=${13}
export HANA_IMAGE_SKU=${14}
export LINUX_JUMPBOX_STATIC_IP=${15}
export LINUX_JUMPBOX_NAME=${16}
export LINUX_JUMPBOX_VM_SIZE=${17}
export LINUX_JUMPBOX_IMAGE_OFFER=${18}
export LINUX_JUMPBOX_IMAGE_PUBLISHER=${19}
export LINUX_JUMPBOX_IMAGE_SKU=${20}
export WINDOWS_JUMPBOX_STATIC_IP=${21}
export WINDOWS_JUMPBOX_NAME=${22}
export WINDOWS_JUMPBOX_VM_SIZE=${23}
export WINDOWS_JUMPBOX_IMAGE_OFFER=${24}
export WINDOWS_JUMPBOX_IMAGE_PUBLISHER=${25}
export WINDOWS_JUMPBOX_IMAGE_SKU=${26}
export APP_IMAGE_OFFER=${27}
export APP_IMAGE_PUBLISHER=${28}
export APP_IMAGE_SKU=${29}
export S4SID=${30}
export SCS_INSTANCE_NUMBER=${31}
export ERS_INSTANCE_NUMBER=${32}
export HA_SCS=${33}
export APP_VM_COUNT=${34}
export APP_VM_SIZING=${35}
export ADMIN_PASSWORD=${36}
export STORAGE_ACCOUNT_NAME=${37}
export STORAGE_ACCESS_KEY=${38}
export PROXIMITY_PLACEMENT_GROUP=${39}
export RESOURCE_GROUP_NAME=${40}
export SUBNET_MANAGEMENT_NAME=${41}
export SUBNET_MANAGEMENT_PREFIX=${42}
export SUBNET_APP_NAME=${43}
export SUBNET_APP_PREFIX=${44}
export SUBNET_DB_NAME=${45}
export SUBNET_DB_PREFIX=${46}
export SAP_USER=${47}
export SAP_PASSWORD=${48}
export SCS_STATIC_IP=${49}
export ERS_STATIC_IP=${50}
export SCS_LB_STATIC_IP=${51}
export ERS_LB_STATIC_IP=${52}
export APP1_STATIC_IP=${53}
export APP2_STATIC_IP=${54}
export APP3_STATIC_IP=${55}
export WEB_STATIC_IP=${56}
export WEB_LB_STATIC_IP=${57}
export PRIVATE_KEY=${58}
